...
module.exports = function(RED) {
  ...
  function convenientpatch_node(n) {
    ...
    this.on('input', function (msg) {
      ...
      var newmsg,
        ConvenientPatch_method = nodegit.ConvenientPatch[node.git_command],
        has_callback = false,
        resolved_arguments = [],
        cb_string,
        cb_args;
      ...
      if (has_callback) {
        ...
        ConvenientPatch_method.apply(ConvenientPatch_method,resolved_arguments);
      } else {
        newmsg.payload.return_value = ConvenientPatch_method.apply(ConvenientPatch_method,resolved_arguments);
        node.send(newmsg);
      }
    });
  }

  RED.nodes.registerType('convenientpatch_node',convenientpatch_node);

  convenientpatch_node.prototype.close = function () {
    console.log('convenientpatch_node closed');
  };
}
